...
export const en: PhbTranslation = {
  ...
  notQualified: {
    ...
    title: 'your profile currently requires a different preparation.',
    titlePrefix: ', ',
    sub: 'This doesn\'t mean you can\'t improve. It means starting a treatment now might not be the right decision — and we prefer to be honest with you rather than risk your health.',
    ...
    steps: [
      { title: 'Get lab work done', desc: 'A complete biomarker profile allows us to evaluate your regenerative viability with clinical criteria.' },
      { title: 'Start with a primary care doctor', desc: 'Get a baseline diagnosis before exploring advanced regenerative therapies.' },
      { title: 'Come back when you\'re ready', desc: 'Once you have recent lab work and medical follow-up, your profile may qualify.' },
    ],
    ctaText: 'When you\'re ready with your lab work, come back and re-evaluate your profile.',
    ctaBtn: 'Back to home',
    footer: { rights: 'All rights reserved.', privacy: 'Privacy Policy', legal: 'Legal Notice' },
  },
}
