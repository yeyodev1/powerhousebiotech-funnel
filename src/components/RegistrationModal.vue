...
const handleSubmit = async () => {
  ...
  // Meta Pixel + CAPI — Lead + CompleteRegistration (deduplicado vía event_id)
  const metaUserData = {
  ...
  sendMetaEvent({
    ...
    eventId: regEventId,
    userData: metaUserData,
    customData: { content_name: 'registro-web' },
  })
